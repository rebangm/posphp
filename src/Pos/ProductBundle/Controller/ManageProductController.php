...
class ManageProductController extends Controller
{
    public function indexAction($page)
    {
        ...
        return $this->render('PosProductBundle:ManageProduct:manage.html.twig',
    ...
    public function editAction(Product $product){
        ...
        return $this->render('PosProductBundle:ManageProduct:edit.html.twig',
    ...
    public function addAction(){
        ...
        return $this->render('PosProductBundle:ManageProduct:add.html.twig',
            array( 'form' => $form->createView(), 'id'   => $product->getId() ));
    }
